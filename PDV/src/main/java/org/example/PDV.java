...
public class PDV extends JFrame {
    ...
    private final JTextField campoPago;
    private final JLabel labelTotal;
    private final JLabel labelTroco;
    ...
    public PDV() {
        ...
        // Ações
        btnAdicionar.addActionListener(_ -> adicionarProduto());
        btnFinalizar.addActionListener(_ -> finalizarVenda());
        btnLimpar.addActionListener(_ -> limparCarrinho());
    ...
    private void adicionarProduto() {
        ...
        for (ItemVenda item : carrinho) {
            if (item.getProduto().codigo().equals(codigo)) {
    ...
    private void calcularTotal() {
        double total = carrinho.stream()
                .mapToDouble(i -> i.getProduto().preco() * i.getQuantidade())
                .sum();
    ...
    // Classes internas
        record Produto(String codigo, String nome, double preco) {
    }
